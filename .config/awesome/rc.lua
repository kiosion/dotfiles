...
user = {
    ...
    browser = "firefox",
    file_manager = "nemo",
    editor = "alacritty --class editor -e vim",
    ...
    dirs = {
        ...
        documents = os.getenv("XDG_DOCUMENTS_DIR") or "~/Nextcloud/Documents",
        music = os.getenv("XDG_MUSIC_DIR") or "/mnt/kepler/Music",
        pictures = os.getenv("XDG_PICTURES_DIR") or "~/Nextcloud/Photos",
        videos = os.getenv("XDG_VIDEOS_DIR") or "~/Nextcloud/Videos",
        -- Make sure the directory exists so that your screenshots
        -- are not lost
        screenshots = os.getenv("XDG_SCREENSHOTS_DIR") or "~/Nextcloud/Photos/Screenshots",
    },
